  ...
  return (
    <div className="max-w-4xl mx-auto px-6 lg:px-10 py-8 lg:py-12">
      ...
      {conteudo.tipo === "video" && conteudo.vimeo_id && (
        <div className="aspect-video rounded-2xl overflow-hidden bg-ink noite-shadow-lg mb-8">
          <iframe
      ...
      {conteudo.tipo === "material" && conteudo.material_url && (
        <div className="rounded-2xl bg-areia-50 noite-border-rich p-8 mb-8 text-center">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 px-6 py-3 rounded-md noite-border-rich text-noite-700 hover:bg-noite-50 text-sm tracking-[0.05em] uppercase font-medium transition-all"
          >
        ...
        <button
          ...
          className={cn(
            ...
            concluido
              ...
              : "bg-noite-foil text-white border-transparent hover:opacity-90 noite-shadow",
          )}
        >
          {concluido ? (
            <>
      ...
      <div className="grid gap-3 sm:grid-cols-2 border-t border-noite-200/40 pt-6">
        {anterior ? (
          <Link
            href={anterior.href}
            className="group rounded-xl bg-areia-50 noite-border p-4 flex items-start gap-3 hover:noite-shadow transition-all"
          >
        ...
        {seguinte ? (
          <Link
            href={seguinte.href}
            className="group rounded-xl bg-areia-50 noite-border p-4 flex items-start gap-3 justify-end text-right hover:noite-shadow transition-all sm:col-start-2"
          >
            <div className="min-w-0">
              <p className="text-[10px] tracking-[0.3em] uppercase text-noite-600 mb-1">
                Seguinte
